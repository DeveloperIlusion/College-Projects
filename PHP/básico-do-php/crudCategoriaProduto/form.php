...
if ($_GET['acao'] != "insert") {
    ...
    try {        
        ...
        $data = $conn->prepare("SELECT * FROM categoriaproduto WHERE id = ?");
...
<html lang="pt-br">
    ...
    <body>
        ...
        <div class="container">
            ...
            <h2>Categoria de Produtos - <?= $subMenu[$_GET['acao']] ?></h2>

            <form method="POST" action="<?= $_GET['acao'] ?>Categoriaproduto.php">

                <div class="row mt-5">
                    <div class="mb-3 col-8">
                        <label for="descricao" class="form-label">Descrição</label>
                        <input type="text" class="form-control" name="descricao"  id="descricao" placeholder="Descrição/nome da categoria de produtos" value="<?= $data['descricao'] ?>">
                    </div>
