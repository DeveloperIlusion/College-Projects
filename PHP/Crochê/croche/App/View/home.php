<div class="home-banner">
    <img src="<?= baseUrl() ?>uploads/logo_crochê-branca" class="img-fluid banner-image" type="image/png">
...
<div class="container mb-5">
    <div class="row mt-5">
        ...
        <div class="col-md-6 p-5 home-bloco-3 alignment">
            ...
            <button class="btn btn-outline-danger col-12" href="<?= baseUrl() ?>home/loja">Loja</button>
            </a>
        </div>
    </div>
